...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recupe_with_tags(self):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Aubergine with takini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipe_by_ingradients(self):
        """Test returning recipes with specific ingradients"""
